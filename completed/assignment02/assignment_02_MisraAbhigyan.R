...
voter_turnout_df1 <- read_excel(path = 'data/G04ResultsDetail2004-11-02.xls' , skip = 1, sheet = 'Voter Turnout')
...
voter_turnout_df2 <- read_excel(path = 'data/G04ResultsDetail2004-11-02.xls' , skip = 2, sheet = 'Voter Turnout', col_names = c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout"))
