...
ggsave("C:/git-bellevue/dsc520-fork/completed/assignment04/plots/01-sex-vs-earn-MisraAbhigyan.png")
## race vs. earn
ggplot(heights_df, aes(x=race, y=earn)) + geom_point()+ geom_boxplot()
ggsave("C:/git-bellevue/dsc520-fork/completed/assignment04/plots/02-race-vs-earn-MisraAbhigyan.png")

# https://ggplot2.tidyverse.org/reference/geom_bar.html
## Using `geom_bar()` plot a bar chart of the number of records for each `sex`
ggplot(heights_df, aes(sex)) + geom_bar()
ggsave("C:/git-bellevue/dsc520-fork/completed/assignment04/plots/03-sex-bar-chart-MisraAbhigyan.png")

## Using `geom_bar()` plot a bar chart of the number of records for each race
ggplot(heights_df, aes(race)) + geom_bar()
ggsave("C:/git-bellevue/dsc520-fork/completed/assignment04/plots/04-race-bar-chart-MisraAbhigyan.png")

## Create a horizontal bar chart by adding `coord_flip()` to the previous plot
ggplot(heights_df, aes(race)) + geom_bar() + coord_flip()
ggsave("C:/git-bellevue/dsc520-fork/completed/assignment04/plots/05-race-horizontal-bar-chart-MisraAbhigyan.png")
...
ggsave("C:/git-bellevue/dsc520-fork/completed/assignment04/plots/06-florida-cases-MisraAbhigyan.png")
...
ggsave("C:/git-bellevue/dsc520-fork/completed/assignment04/plots/07-all-cases-MisraAbhigyan.png")
...
ggsave("C:/git-bellevue/dsc520-fork/completed/assignment04/plots/08-all-cases-color-MisraAbhigyan.png")
...
ggplot(data=florida_df, aes(x=date, group=1)) +
  ...
  xlab(" ") + ylab("Cases")
ggsave("C:/git-bellevue/dsc520-fork/completed/assignment04/plots/09-all-cases-legend-MisraAbhigyan.png")
...
ggsave("C:/git-bellevue/dsc520-fork/completed/assignment04/plots/10-all-cases-log-MisraAbhigyan.png")
